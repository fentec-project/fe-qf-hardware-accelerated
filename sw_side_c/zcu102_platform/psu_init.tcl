...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0034 0xFE7FEDEF 0x7E5AAC62
		# : UPDATE FB_DIV
    ...
    mask_write 0XFF5E0030 0x00717F00 0x00013300
		# : BY PASS PLL
		# Register : RPLL_CTRL @ 0XFF5E0030</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFD1A0074 0x013F3F07 0x01011103
    ...
    mask_write 0XFD1A007C 0x013F3F07 0x01011003
